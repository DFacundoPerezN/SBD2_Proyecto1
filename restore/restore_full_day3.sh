#!/usr/bin/env bash
# =============================================================================
# Proyecto 2 - SBD2: Restauración desde Full Backup — Día 3
# (Estado final: paises en MAYUSCULAS + todos los partidos 2026)
# Uso: sudo bash restore_full_day3.sh
# =============================================================================
...
BACKUP_DIR="${FULL_DIR}/day3"
LOG_FILE="${LOG_DIR}/restore_full_day3.log"

echo "============================================================" | tee "${LOG_FILE}"
echo "  RESTAURACION FULL BACKUP - DIA 3" | tee -a "${LOG_FILE}"
...
echo "3,FULL,RESTORE,$(date -d "@$((RESTORE_START/1000000000))" '+%Y-%m-%d %H:%M:%S'),$(date '+%Y-%m-%d %H:%M:%S'),${RESTORE_MS},${RESTORE_SEC}" >> "${TIMES_FILE}"

echo "[OK] Restauracion Full Dia 3 completada."
